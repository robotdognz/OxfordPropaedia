...
def export_worklists(connection: sqlite3.Connection) -> None:
    ...
    identity_rows = [
        {
            ...
            "suggested_propaedia_name_source_sections": alias_summary.get(
                (int(row["volume_number"]), row["start_page_label"]),
                {},
            ).get("suggested_source_sections", ""),
    ...
    write_csv(
        ...
        [
            ...
            "suggested_propaedia_name_source_sections",
