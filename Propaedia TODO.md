Propaedia TODO:
    ...
    - Macropaedia data needed for app (first pass)
        ...
        - Page of the article inside that volume
        - Both normally formatted name and alphabetical comma name
        - Still need to get the page numbers for last articles in each volume manually

    - Next phase Macropaedia data
        - Contents pages and intro paragrpahs for every article
            - For info on Macropaedia pages in app
            - For subsection mapping in the outline
            - For finding matching live articles on the Britannica website
