...
- Recommendations:
  ...
  - `Biological Sciences, The` -> `The BIOLOGICAL SCIENCES` (v2 p1069)
  - `Photosynthesis` -> `PHOTOSYNTHESIS` (v13 p799)
  ...
  - `Coloration, Biological` -> `Biological COLORATION` (v4 p585)
...
- Recommendations:
  ...
  - `Plants` -> `PLANTS` (v13 p867)
  - `Protists` -> `PROTISTS` (v14 p268)
  - `Protozoa` -> `PROTOZOA` (v14 p279)
  - `Reptiles` -> `REPTILES` (v14 p688)
...
- Recommendations:
  - `Drugs and Drug Action` -> `DRUGS AND DRUG ACTION` (v5 p529)
...
- Recommendations:
  - `Farming and Agricultural Technology` -> `FARMING and Agricultural Technology` (v7 p87)
  - `Biosphere and Concepts of Ecology, The` -> `The BIOSPHERE and Concepts of Ecology` (v2 p1127)
  - `Forestry and Wood Production` -> `FORESTRY AND WOOD PRODUCTION` (v7 p410)
  - `Cats, Domestic` -> `Domestic CATS` (v3 p561)
  - `Gardening and Horticulture` -> `GARDENING AND HORTICULTURE` (v7 p670)
  - `Conservation of Natural Resources` -> unmatched
  - `Horses and Horsemanship` -> `HORSES AND HORSEMANSHIP` (v8 p646)
  - `Dogs` -> `DOGS` (v5 p440)
